	<footer>
    	<div class="footer-info">
        	<h2 id="f-information"><a href="faq.php">Information:</a></h2>
            <ul>
        ...
        <div class="footer-info">
        	<h2 id="f-policies"><a href="faq.php">Policies:</a></h2>
            <ul>
        ...
        <div class="footer-info">
        	<h2 id="f-contact"><a href="contact-us.php">Contact:</a></h2>
            <ul>
            	<li>604.888.8888</li>
                <li><a href="mailto:hello@skyair.com">hello@skyair.com</a></li>
            </ul>
        </div>
        <div class="footer-info">
